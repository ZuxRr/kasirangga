...
if (isset($_POST['tambah'])) {
    ...
    if ($stok) {
        ...
        $sql = $koneksi->query("INSERT INTO pelanggan (idpelanggan, nama, nomeja) VALUES ('$id_transaksi_baru', '$nama', '$nomeja')");
        ...
        foreach ($menu_jumlah as $i => $item) {
            ...
            $sql5 = $koneksi->query("UPDATE produk SET sold = sold + $jumlah WHERE ProdukID = '$produk_id'");
        }
